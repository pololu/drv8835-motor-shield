...
This library configures Timer 1 on the Uno R3, Leonardo, and Duemilanove to generate a 20 kHz PWM frequency for the motors. The library uses analogWrite on the Mega 2560 and Due, which generates 489 Hz and 1 kHz PWM frequencies, respectively, with the default timer configuration.
